 ...
 * @extends lime.Button
 */
dm.Button = function(txt) {
    lime.GlossyButton.call(this, txt);

    this.borderWidth = 4;
    this.setColor('#000');
};
goog.inherits(dm.Button, lime.GlossyButton);

/**
 * @inheritDoc
 */
dm.Button.prototype.makeState_ = function() {
 ...
 * @inheritDoc
 */
dm.Button.prototype.setColor = function(clr) {
